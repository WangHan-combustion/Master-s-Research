...
tmp<volScalarField> WrayAgarwalDESDIT<BasicTurbulenceModel>::chi() const
{
    return Rnu_/this->nu();
}

template<class BasicTurbulenceModel>
tmp<volScalarField> WrayAgarwalDESDIT<BasicTurbulenceModel>::fv1
(
...
template<class BasicTurbulenceModel>
tmp<volScalarField> WrayAgarwalDESDIT<BasicTurbulenceModel>::blend
(
...
template<class BasicTurbulenceModel>
void WrayAgarwalDESDIT<BasicTurbulenceModel>::correctNut
(
...
template<class BasicTurbulenceModel>
tmp<volScalarField> WrayAgarwalDESDIT<BasicTurbulenceModel>::fdes
(
...
template<class BasicTurbulenceModel>
WrayAgarwalDESDIT<BasicTurbulenceModel>::WrayAgarwalDESDIT
(
...
template<class BasicTurbulenceModel>
bool WrayAgarwalDESDIT<BasicTurbulenceModel>::read()
{
...
template<class BasicTurbulenceModel>
tmp<volScalarField> WrayAgarwalDESDIT<BasicTurbulenceModel>::DRnuEff(volScalarField Switch) const
{
...
template<class BasicTurbulenceModel>
tmp<volScalarField> WrayAgarwalDESDIT<BasicTurbulenceModel>::k() const
{
    return tmp<volScalarField>
    (
        new volScalarField
...
template<class BasicTurbulenceModel>
tmp<volScalarField> WrayAgarwalDESDIT<BasicTurbulenceModel>::epsilon() const
{
    WarningInFunction
...
template<class BasicTurbulenceModel>
void WrayAgarwalDESDIT<BasicTurbulenceModel>::correct()
{
    if (!this->turbulence_)
    {
        return;
...
template<class BasicTurbulenceModel>
tmp<volScalarField> WrayAgarwalDESDIT<BasicTurbulenceModel>::LESRegion() const
{
