...
tmp<volScalarField> SADES<BasicTurbulenceModel>::chi() const
{
...
template<class BasicTurbulenceModel>
tmp<volScalarField> SADES<BasicTurbulenceModel>::fv1
(
...
template<class BasicTurbulenceModel>
tmp<volScalarField> SADES<BasicTurbulenceModel>::fv2
(
    const volScalarField& chi,
...
template<class BasicTurbulenceModel>
tmp<volScalarField> SADES<BasicTurbulenceModel>::S
(
...
template<class BasicTurbulenceModel>
tmp<volScalarField> SADES<BasicTurbulenceModel>::Omega
(
    const volTensorField& gradU
) const
{
...
template<class BasicTurbulenceModel>
tmp<volScalarField> SADES<BasicTurbulenceModel>::Stilda
(
    const volScalarField& chi,
    const volScalarField& fv1,
...
template<class BasicTurbulenceModel>
tmp<volScalarField> SADES<BasicTurbulenceModel>::r
(
...
template<class BasicTurbulenceModel>
tmp<volScalarField> SADES<BasicTurbulenceModel>::fw
(
    const volScalarField& Omega,
    const volScalarField& dTilda
) const
...
template<class BasicTurbulenceModel>
tmp<volScalarField> SADES<BasicTurbulenceModel>::dTilda
(
    const volScalarField& chi,
    const volScalarField& fv1,
    const volTensorField& gradU
...
template<class BasicTurbulenceModel>
void SADES<BasicTurbulenceModel>::correctNut
(
    const volScalarField& fv1
)
{
...
template<class BasicTurbulenceModel>
SADES<BasicTurbulenceModel>::SADES
(
...
template<class BasicTurbulenceModel>
bool SADES<BasicTurbulenceModel>::read()
{
...
template<class BasicTurbulenceModel>
tmp<volScalarField> SADES<BasicTurbulenceModel>::
DnuTildaEff() const
{
...
template<class BasicTurbulenceModel>
tmp<volScalarField> SADES<BasicTurbulenceModel>::k() const
{
...
template<class BasicTurbulenceModel>
tmp<volScalarField> SADES<BasicTurbulenceModel>::LESRegion() const
{
    const volScalarField chi(this->chi());
    const volScalarField fv1(this->fv1(chi));
...
template<class BasicTurbulenceModel>
void SADES<BasicTurbulenceModel>::correct()
{
    if (!this->turbulence_)
    {
        return;
