...
tmp<volScalarField> WrayAgarwalDES2<BasicTurbulenceModel>::chi() const
{
    return Rnu_/this->nu();
}

template<class BasicTurbulenceModel>
tmp<volScalarField> WrayAgarwalDES2<BasicTurbulenceModel>::fv1
(
...
template<class BasicTurbulenceModel>
tmp<volScalarField> WrayAgarwalDES2<BasicTurbulenceModel>::blend
(
...
template<class BasicTurbulenceModel>
void WrayAgarwalDES2<BasicTurbulenceModel>::correctNut
(
...
template<class BasicTurbulenceModel>
tmp<volScalarField> WrayAgarwalDES2<BasicTurbulenceModel>::fdes2
(
...
template<class BasicTurbulenceModel>
WrayAgarwalDES2<BasicTurbulenceModel>::WrayAgarwalDES2
(
...
template<class BasicTurbulenceModel>
bool WrayAgarwalDES2<BasicTurbulenceModel>::read()
{
...
template<class BasicTurbulenceModel>
tmp<volScalarField> WrayAgarwalDES2<BasicTurbulenceModel>::DRnuEff(volScalarField Switch) const
{
...
template<class BasicTurbulenceModel>
tmp<volScalarField> WrayAgarwalDES2<BasicTurbulenceModel>::k() const
{
    return tmp<volScalarField>
    (
        new volScalarField
...
template<class BasicTurbulenceModel>
tmp<volScalarField> WrayAgarwalDES2<BasicTurbulenceModel>::epsilon() const
{
    WarningInFunction
...
template<class BasicTurbulenceModel>
void WrayAgarwalDES2<BasicTurbulenceModel>::correct()
{
    if (!this->turbulence_)
    {
        return;
...
template<class BasicTurbulenceModel>
tmp<volScalarField> WrayAgarwalDES2<BasicTurbulenceModel>::LESRegion() const
{
