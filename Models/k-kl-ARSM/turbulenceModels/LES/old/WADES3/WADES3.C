...
tmp<volScalarField> WADES3<BasicTurbulenceModel>::chi() const
{
    return Rnu_/this->nu();
}

template<class BasicTurbulenceModel>
tmp<volScalarField> WADES3<BasicTurbulenceModel>::fv1
(
...
template<class BasicTurbulenceModel>
tmp<volScalarField> WADES3<BasicTurbulenceModel>::blend
(
...
template<class BasicTurbulenceModel>
void WADES3<BasicTurbulenceModel>::correctNut
(
...
template<class BasicTurbulenceModel>
tmp<volScalarField> WADES3<BasicTurbulenceModel>::fdes2
(
...
) const
{
    ...
    else
    {
        // running WA-DDES
        // Switch = 0~1, 
        //      Lles > Lrans, RANS mode
        //      Lles < Lrans, fdes2 = Switch_ + (1-Switch_)*Lles2*Lrans2R
        if(DDES_)
        {
            return scalar(1) - (scalar(1) - Switch_) * max
                                                            (
                                                                scalar(1) - Lles2*Lrans2R,
                                                                scalar(0)
                                                            );
        }
        // running WA-DES
...
template<class BasicTurbulenceModel>
WADES3<BasicTurbulenceModel>::WADES3
(
...
template<class BasicTurbulenceModel>
bool WADES3<BasicTurbulenceModel>::read()
{
...
template<class BasicTurbulenceModel>
tmp<volScalarField> WADES3<BasicTurbulenceModel>::DRnuEff(volScalarField Switch) const
{
...
template<class BasicTurbulenceModel>
tmp<volScalarField> WADES3<BasicTurbulenceModel>::k() const
{
    return tmp<volScalarField>
    (
        new volScalarField
...
template<class BasicTurbulenceModel>
tmp<volScalarField> WADES3<BasicTurbulenceModel>::epsilon() const
{
    WarningInFunction
...
template<class BasicTurbulenceModel>
void WADES3<BasicTurbulenceModel>::correct()
{
    if (!this->turbulence_)
    {
        return;
...
////////////////////////////////////////////////////////////////
    ...
    //volScalarField boundEke = sqr(Rnu_)*min(sqr(1.0/Lvk),sqr(1.0/y_));
    const volScalarField Lrans2R = min(sqr(1.0/Lvk),sqr(1.0/y_));
    volScalarField boundEke = sqr(Rnu_)*Lrans2R;
...
////////////////////////////////////////////////////////////////
    ...
    // Blend Scheme
    // blendfactor = 1 for using the first scheme, blendfactor = 1 for using the second scheme
...
template<class BasicTurbulenceModel>
tmp<volScalarField> WADES3<BasicTurbulenceModel>::LESRegion() const
{
