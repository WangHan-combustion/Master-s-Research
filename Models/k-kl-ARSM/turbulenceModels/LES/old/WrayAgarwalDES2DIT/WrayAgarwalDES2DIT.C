...
tmp<volScalarField> WrayAgarwalDES2DIT<BasicTurbulenceModel>::chi() const
{
    return Rnu_/this->nu();
}

template<class BasicTurbulenceModel>
tmp<volScalarField> WrayAgarwalDES2DIT<BasicTurbulenceModel>::fv1
(
...
template<class BasicTurbulenceModel>
tmp<volScalarField> WrayAgarwalDES2DIT<BasicTurbulenceModel>::blend
(
...
template<class BasicTurbulenceModel>
void WrayAgarwalDES2DIT<BasicTurbulenceModel>::correctNut
(
...
template<class BasicTurbulenceModel>
tmp<volScalarField> WrayAgarwalDES2DIT<BasicTurbulenceModel>::fdes2
(
...
) const
{
    ...
    return Lles2*Lrans2r;
}

// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //

template<class BasicTurbulenceModel>
WrayAgarwalDES2DIT<BasicTurbulenceModel>::WrayAgarwalDES2DIT
(
	...
	)
{
    ...
    if (DIT1_)
    {
        Info<< "Decaying Isotropic Turbulence (DIT) on the first destruction term" << endl << endl;
    }
    else
    {
        Info<< "Decaying Isotropic Turbulence (DIT) on the second destruction term (normal)" << endl << endl;
    }
}
...
template<class BasicTurbulenceModel>
bool WrayAgarwalDES2DIT<BasicTurbulenceModel>::read()
{
...
template<class BasicTurbulenceModel>
tmp<volScalarField> WrayAgarwalDES2DIT<BasicTurbulenceModel>::DRnuEff(volScalarField Switch) const
{
...
template<class BasicTurbulenceModel>
tmp<volScalarField> WrayAgarwalDES2DIT<BasicTurbulenceModel>::k() const
{
    return tmp<volScalarField>
    (
        new volScalarField
...
template<class BasicTurbulenceModel>
tmp<volScalarField> WrayAgarwalDES2DIT<BasicTurbulenceModel>::epsilon() const
{
    WarningInFunction
...
template<class BasicTurbulenceModel>
void WrayAgarwalDES2DIT<BasicTurbulenceModel>::correct()
{
    if (!this->turbulence_)
    {
        return;
...
template<class BasicTurbulenceModel>
tmp<volScalarField> WrayAgarwalDES2DIT<BasicTurbulenceModel>::LESRegion() const
{
