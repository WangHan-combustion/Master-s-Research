...
tmp<volScalarField> WrayAgarwalDESfdes<BasicTurbulenceModel>::chi() const
{
    return Rnu_/this->nu();
}

template<class BasicTurbulenceModel>
tmp<volScalarField> WrayAgarwalDESfdes<BasicTurbulenceModel>::fv1
(
...
template<class BasicTurbulenceModel>
tmp<volScalarField> WrayAgarwalDESfdes<BasicTurbulenceModel>::blend
(
...
template<class BasicTurbulenceModel>
void WrayAgarwalDESfdes<BasicTurbulenceModel>::correctNut
(
...
template<class BasicTurbulenceModel>
tmp<volScalarField> WrayAgarwalDESfdes<BasicTurbulenceModel>::fdes
(
...
template<class BasicTurbulenceModel>
WrayAgarwalDESfdes<BasicTurbulenceModel>::WrayAgarwalDESfdes
(
...
template<class BasicTurbulenceModel>
bool WrayAgarwalDESfdes<BasicTurbulenceModel>::read()
{
...
template<class BasicTurbulenceModel>
tmp<volScalarField> WrayAgarwalDESfdes<BasicTurbulenceModel>::DRnuEff(volScalarField Switch) const
{
...
template<class BasicTurbulenceModel>
tmp<volScalarField> WrayAgarwalDESfdes<BasicTurbulenceModel>::k() const
{
    return tmp<volScalarField>
    (
        new volScalarField
...
template<class BasicTurbulenceModel>
tmp<volScalarField> WrayAgarwalDESfdes<BasicTurbulenceModel>::epsilon() const
{
    WarningInFunction
...
template<class BasicTurbulenceModel>
void WrayAgarwalDESfdes<BasicTurbulenceModel>::correct()
{
    if (!this->turbulence_)
    {
        return;
...
////////////////////////////////////////////////////////////////
	...
	fdes_ = fdes;
	fdes_.correctBoundaryConditions();	
...
template<class BasicTurbulenceModel>
tmp<volScalarField> WrayAgarwalDESfdes<BasicTurbulenceModel>::LESRegion() const
{
