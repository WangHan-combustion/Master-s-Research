...
tmp<volScalarField> kkloneM<BasicTurbulenceModel>::chi() const
{
    return nuTilda_/(this->nu());
}

template<class BasicTurbulenceModel>
tmp<volScalarField> kkloneM<BasicTurbulenceModel>::ka
(
...
template<class BasicTurbulenceModel>
tmp<volScalarField> kkloneM<BasicTurbulenceModel>::len
(
    const volScalarField& S
) const
{
...
template<class BasicTurbulenceModel>
tmp<volScalarField> kkloneM<BasicTurbulenceModel>::lvkmin
(
...
template<class BasicTurbulenceModel>
tmp<volScalarField> kkloneM<BasicTurbulenceModel>::ep
(
...
template<class BasicTurbulenceModel>
tmp<volScalarField> kkloneM<BasicTurbulenceModel>::fphi
(
...
template<class BasicTurbulenceModel>
void kkloneM<BasicTurbulenceModel>::correctNut()
{
    this->nut_ = nuTilda_;
...
template<class BasicTurbulenceModel>
kkloneM<BasicTurbulenceModel>::kkloneM
(
...
template<class BasicTurbulenceModel>
bool kkloneM<BasicTurbulenceModel>::read()
{
...
template<class BasicTurbulenceModel>
tmp<volScalarField> kkloneM<BasicTurbulenceModel>::DnuTildaEff() const
{
...
template<class BasicTurbulenceModel>
tmp<volScalarField> kkloneM<BasicTurbulenceModel>::DklEff() const
{
    return tmp<volScalarField>
    (
        new volScalarField("DklEff", this->nut_ + this->nu())
    );
}

template<class BasicTurbulenceModel>
tmp<volScalarField> kkloneM<BasicTurbulenceModel>::DkEff() const
{
    return tmp<volScalarField>
    (
...
template<class BasicTurbulenceModel>
void kkloneM<BasicTurbulenceModel>::correct()
{
    if (!this->turbulence_)
    {
        return;
