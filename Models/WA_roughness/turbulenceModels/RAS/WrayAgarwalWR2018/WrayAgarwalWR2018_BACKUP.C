...
{
    //return Rnu_/this->nu();
    return (Rnu_/this->nu())+;//1.3*0.03*mag(this->U_)*ks_/this->nu();//+Cr1_*ks_/(y_+0.03*ks_);
}
...
{
    //return this->nut_  * omega*1.0/(1.0+mag(this->U_)*ks_/this->nu());
	//return Rnu_*omega;
	return this->nut_ * omega;//*1.0/(1.0+33.698031*0.0008683/(1.54e-5));
}
