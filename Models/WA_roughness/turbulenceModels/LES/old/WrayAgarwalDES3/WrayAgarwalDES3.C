...
tmp<volScalarField> WrayAgarwalDES3<BasicTurbulenceModel>::chi() const
{
    return Rnu_/this->nu();
}

template<class BasicTurbulenceModel>
tmp<volScalarField> WrayAgarwalDES3<BasicTurbulenceModel>::fv1
(
...
template<class BasicTurbulenceModel>
tmp<volScalarField> WrayAgarwalDES3<BasicTurbulenceModel>::blend
(
...
template<class BasicTurbulenceModel>
void WrayAgarwalDES3<BasicTurbulenceModel>::correctNut
(
...
template<class BasicTurbulenceModel>
tmp<volScalarField> WrayAgarwalDES3<BasicTurbulenceModel>::fdes2
(
...
template<class BasicTurbulenceModel>
WrayAgarwalDES3<BasicTurbulenceModel>::WrayAgarwalDES3
(
...
template<class BasicTurbulenceModel>
bool WrayAgarwalDES3<BasicTurbulenceModel>::read()
{
...
template<class BasicTurbulenceModel>
tmp<volScalarField> WrayAgarwalDES3<BasicTurbulenceModel>::DRnuEff(volScalarField Switch) const
{
...
template<class BasicTurbulenceModel>
tmp<volScalarField> WrayAgarwalDES3<BasicTurbulenceModel>::k() const
{
    return tmp<volScalarField>
    (
        new volScalarField
...
template<class BasicTurbulenceModel>
tmp<volScalarField> WrayAgarwalDES3<BasicTurbulenceModel>::epsilon() const
{
    WarningInFunction
...
template<class BasicTurbulenceModel>
void WrayAgarwalDES3<BasicTurbulenceModel>::correct()
{
    if (!this->turbulence_)
    {
        return;
...
template<class BasicTurbulenceModel>
tmp<volScalarField> WrayAgarwalDES3<BasicTurbulenceModel>::LESRegion() const
{
