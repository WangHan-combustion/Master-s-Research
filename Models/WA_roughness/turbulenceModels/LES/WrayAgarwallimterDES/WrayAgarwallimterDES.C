...
#include "WrayAgarwallimterDES.H"
...
tmp<volScalarField> WrayAgarwallimterDES<BasicTurbulenceModel>::chi() const
{
    return Rnu_/this->nu();
}

template<class BasicTurbulenceModel>
tmp<volScalarField> WrayAgarwallimterDES<BasicTurbulenceModel>::fv1
(
...
template<class BasicTurbulenceModel>
tmp<volScalarField> WrayAgarwallimterDES<BasicTurbulenceModel>::blend
(
...
template<class BasicTurbulenceModel>
void WrayAgarwallimterDES<BasicTurbulenceModel>::correctNut
(
...
template<class BasicTurbulenceModel>
tmp<volScalarField> WrayAgarwallimterDES<BasicTurbulenceModel>::fdes
(
...
template<class BasicTurbulenceModel>
WrayAgarwallimterDES<BasicTurbulenceModel>::WrayAgarwallimterDES
(
...
template<class BasicTurbulenceModel>
bool WrayAgarwallimterDES<BasicTurbulenceModel>::read()
{
...
template<class BasicTurbulenceModel>
tmp<volScalarField> WrayAgarwallimterDES<BasicTurbulenceModel>::DRnuEff(volScalarField Switch) const
{
...
template<class BasicTurbulenceModel>
tmp<volScalarField> WrayAgarwallimterDES<BasicTurbulenceModel>::k() const
{
    return tmp<volScalarField>
    (
        new volScalarField
...
template<class BasicTurbulenceModel>
tmp<volScalarField> WrayAgarwallimterDES<BasicTurbulenceModel>::epsilon() const
{
    WarningInFunction
...
template<class BasicTurbulenceModel>
void WrayAgarwallimterDES<BasicTurbulenceModel>::correct()
{
    if (!this->turbulence_)
    {
        return;
...
//////////////////////////////////////////////////////////////
	...
	volScalarField Ebb = max(magSqr(fvc::grad(Rnu_)),dimensionedScalar("EbbMin", dimensionSet(0, 2, -2, 0, 0), SMALL));
...
////////////////////////////////////////////////////////////////
	...
	// Calculate fdes
	const volScalarField fdes(this->fdes(S));
...
////////////////////////////////////////////////////////////////
    ...
    (
     ...
     ==
	  ...
	  - (1.0-Switch1_)*alpha*rho*C2ke_*3.0*Ebb*tanh(Eke/(3.0*Ebb))/fdes2
    );
...
template<class BasicTurbulenceModel>
tmp<volScalarField> WrayAgarwallimterDES<BasicTurbulenceModel>::LESRegion() const
{
